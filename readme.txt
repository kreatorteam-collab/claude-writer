...
* Siguranță: dacă nota de final iese goală (doar „Notă:"), e completată automat cu disclaimer-ul configurat.

= 1.2.5 =
* „Verifică update" funcționează acum instant: updater-ul întreabă API-ul GitHub (proaspăt, fără cache), nu raw.githubusercontent (care avea cache CDN de câteva minute ce ignora cache-buster-ul, deci arăta versiunea veche). Raw rămâne ca rezervă.
...
* Nota de final (disclaimer) e mutată automat la finalul ABSOLUT al articolului, după paragraful de încheiere — indiferent unde o pune modelul.
